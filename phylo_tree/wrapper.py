...
def set_params(subst_rates, trans_rates, ancestor_dist, backg_dist, ancestor_length, num_descend, cut_off, num_TEs, backg_len, randd, tree_str):
    ...
    for line in myfile:
        ...
        if arr[0] == "distribution" and randd[0] == True:         # Distribution to generate random numbers for TE cut off
            ...
            line = str_randd
        if arr[0] == "tree" and tree_str[0] == True:         # Tree discription of the TE family (we will use either this option or "number TEs in the genome"
            print line
            line = myfile.next()
            line = tree_str[1]
        print line
...
def main():
    ...
    parser.add_argument('-ts', '--tree_str', action = 'store', dest = 'treeStr', default = None, \
                        type = str, help = 'Tree discription of the TE family (we will use either this option or number TEs in the genome')
    ...
    tree_str[1] = args.treeStr
    #print subst_rates, trans_rates, ancestor_dist, backg_dist, ancestor_length, num_descend, cut_off, num_TEs, backg_len, randd
        
    set_params(subst_rates, trans_rates, ancestor_dist, backg_dist, ancestor_length, num_descend, cut_off, num_TEs, backg_len, randd, tree_str)
